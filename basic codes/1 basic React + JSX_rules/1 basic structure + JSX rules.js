...
// ReactDom.render(<Greeting>, document.getElementById('root'));     // error , Greeting tag not closed
ReactDom.render(<Greeting />, document.getElementById("root")); // self closing tag
ReactDom.render(<Greeting></Greeting>, document.getElementById("root")); // also works
...
function Greeting() {
	// return multiple elements || return using ( ) and life will be easy
	return (
		<div>
			<h1>Hello World</h1>
		</div>
